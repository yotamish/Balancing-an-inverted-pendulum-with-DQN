...
%         buffer_state = [curr_state(3);((curr_state(3)-curr_state(4))/DESIRED_LOOP_TIME);(curr_state(1)*pi/180);(curr_state(1)*pi/180 - curr_state(2)*pi/180 )/DESIRED_LOOP_TIME];
%         buffer_state = [curr_state(3);((curr_state(3)-curr_state(4))/DESIRED_LOOP_TIME);curr_state(1)*pi/180;(curr_state(1) - curr_state(2))*(pi/180)/DESIRED_LOOP_TIME];
